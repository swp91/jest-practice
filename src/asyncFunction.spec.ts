...
// mockReturnValue(Promise.reject('no)) 대신 mockRejectedValue('ok) 쓸수있음 성공할떈 mockResolvedValue
test("noPromise 테스트 스파이심음", () => {
